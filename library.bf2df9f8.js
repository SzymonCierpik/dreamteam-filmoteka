 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */};hE.addEventListener("submit",(e=>{e.preventDefault(),dE.classList.contains("error")||pE.classList.contains("error")||LE()}));const PE=async()=>{const e=Zw.value,t=rE.value,n=tE.value;try{const r=await Ko(kE,e,t);await Go(kE.currentUser,{displayName:n});const i=Hv(NE,"users",`${r.user.uid}`);await Dw(i,{watched:[],queue:[]})}catch(e){oE.style.display="block",oE.innerHTML=`<i class="bx bx-error-circle singup-error-icon"></i>${e.message}`,console.log(e)}};Yw.addEventListener("submit",(e=>{e.preventDefault(),PE(),Xw.classList.contains("invalid")||nE.classList.contains("invalid")||iE.classList.contains("invalid")||eE.classList.contains("invalid")||PE()}));(async()=>{var e,t,n;e=e=>{e?(RE=e.uid,OE=e.displayName,DE=!0,Yw.reset(),hE.reset()):(DE=!1,vE(),null===yE&&localStorage.setItem("guest",JSON.stringify({watched:[],queue:[]})))},ar(kE).onAuthStateChanged(e,t,n)})();const ME=async()=>{var e;await(e=kE,ar(e).signOut())};AE.addEventListener("click",(()=>{ME(),jw.classList.toggle("menu-is-hidden"),setTimeout(Kw,300)}));const xE=async()=>{const e=await Rw(Hv(NE,"users",`${RE}`));if(e.exists()){return e.data()}console.log("No such document!")};function UE(e){DE?(async e=>{await Lw(Hv(NE,"users",`${RE}`),{watched:xw(`${e}`)})})(e):wE(e)}function FE(e){DE?(async e=>{await Lw(Hv(NE,"users",`${RE}`),{queue:xw(`${e}`)})})(e):EE(e)}function VE(){const e=TE.querySelector("#watched"),t=TE.querySelector("#queue");e.addEventListener("click",(e=>{UE(e.currentTarget.dataset.id)})),t.addEventListener("click",(e=>{FE(e.currentTarget.dataset.id)}))}const BE=document.querySelector(".films-cards-set");let jE;const qE=document.querySelector(".empty__library");document.querySelector("[data-watched]").addEventListener("click",(()=>{DE?xE().then((e=>{jE=e,BE.innerHTML="",qE.classList.add("john-is-hidden"),pn(jE.watched).then((e=>{BE.insertAdjacentHTML("beforeend",s(e));document.querySelectorAll(".film-card").forEach((e=>{e.addEventListener("click",(e=>{IE(e.currentTarget.dataset.id).then((e=>e.data)).then((e=>{TE.innerHTML=bE(e),SE(),VE()})).catch((e=>{throw new Error(e)}))}))}))}))})):(vE(),BE.innerHTML="",qE.classList.add("john-is-hidden"),pn(yE.watched).then((e=>{BE.insertAdjacentHTML("beforeend",s(e));document.querySelectorAll(".film-card").forEach((e=>{e.addEventListener("click",(e=>{IE(e.currentTarget.dataset.id).then((e=>e.data)).then((e=>{TE.innerHTML=bE(e),SE(),VE()})).catch((e=>{throw new Error(e)}))}))}))})))}));document.querySelector("[data-queue]").addEventListener("click",(()=>{DE?xE().then((e=>{jE=e,BE.innerHTML="",qE.classList.add("john-is-hidden"),pn(jE.queue).then((e=>{BE.insertAdjacentHTML("beforeend",s(e));document.querySelectorAll(".film-card").forEach((e=>{e.addEventListener("click",(e=>{IE(e.currentTarget.dataset.id).then((e=>e.data)).then((e=>{TE.innerHTML=bE(e),SE(),VE()})).catch((e=>{throw new Error(e)}))}))}))}))})):(vE(),BE.innerHTML="",qE.classList.add("john-is-hidden"),pn(yE.queue).then((e=>{BE.insertAdjacentHTML("beforeend",s(e));document.querySelectorAll(".film-card").forEach((e=>{e.addEventListener("click",(e=>{IE(e.currentTarget.dataset.id).then((e=>e.data)).then((e=>{TE.innerHTML=bE(e),SE(),VE()})).catch((e=>{throw new Error(e)}))}))}))})))}));const $E=document.querySelector(".backdrop--flex");document.querySelector(".footer__font").addEventListener("click",(e=>{e.preventDefault(),$E.classList.remove("is-hidden")})),$E.addEventListener("click",(e=>{e.currentTarget===e.target&&$E.classList.add("is-hidden")})),window.addEventListener("keydown",(e=>{"Escape"!==e.key||$E.classList.add("is-hidden")}));
//# sourceMappingURL=library.bf2df9f8.js.map
