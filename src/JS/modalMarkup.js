function renderMarkup({
  ...
  const markup = `<div class="movie-info-content">
      <img class="movie-detail__image" src="https://image.tmdb.org/t/p/w500//${poster_path}" />
          ...
          <li class="modal__item">
            ...
            <div class="modal__item--vote">
              <p class="modal__item--value modal__item--value--vote">
                <vote_average>${vote_average.toFixed(
                  1
                )}</vote_average>/<vote__count>${vote_count}</vote__count>
              </p></div></li>
              <li class="modal__item">
